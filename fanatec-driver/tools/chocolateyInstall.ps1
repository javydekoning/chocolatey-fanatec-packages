...
$url = 'https://fanatec.com/media/archive/00/d6/9c/2022-02-18-Fanatec_driver_439.zip'
...
$downloadArgs = @{
  ...
  url          = $url
  checksum     = 'e798643d10e7fb6289c6fce44cc6af3cc47651520f0890575085f0d631fde0e1'
  checksumType = 'sha256'
  options      = @{
    Headers = @{             
      Accept = '*/*'
