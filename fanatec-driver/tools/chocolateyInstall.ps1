...
$url = 'https://fanatec.com/media/archive/79/65/25/2022-08-30-Fanatec_driver_447.zip'
...
$downloadArgs = @{
  ...
  url          = $url
  checksum     = 'f4f42d08fb47ce97dd744feeca5c7da3e4459450567fe3adf8eb319316480dbc'
  checksumType = 'sha256'
  options      = @{
    Headers = @{             
      Accept = '*/*'
