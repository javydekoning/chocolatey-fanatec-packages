...
$url = 'https://fanatec.com/media/archive/93/10/49/2021-08-17-Fanatec_driver_410.zip'
...
$downloadArgs = @{
  ...
  url          = $url
  checksum     = '88bfadf27e385bcb4c37d3905b5ed611f85319fa35d2837159c0d9330cda8903'
  checksumType = 'sha256'
  options      = @{
    Headers = @{             
      Accept = '*/*'
