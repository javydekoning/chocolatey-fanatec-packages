...
$url = 'https://fanatec.com/media/archive/cc/fb/fd/2022-02-04-Fanatec_driver_436.zip'
...
$downloadArgs = @{
  ...
  url          = $url
  checksum     = 'd3a7a1e8a80fdebf2b85f07182398423ececacdafdc8fce3e0c30245bbe7254f'
  checksumType = 'sha256'
  options      = @{
    Headers = @{             
      Accept = '*/*'
